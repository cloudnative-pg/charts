...
| cluster.env | list | `[]` | The list of environment variables See: https://cloudnative-pg.io/documentation/current/cluster_conf/#environment-variables |
| cluster.envFrom | list | `[]` | The list of environment variables references |
