...
| replica.bootstrap.type | string | `""` | One of `object_store` or `pg_basebackup`. Method to use for bootstrap. |
...
| replica.origin.objectStore.provider | string | `"s3"` | One of `s3`, `azure` or `google` |
...
| replica.replication.type | string | `""` | One of `object_store` or `pg_basebackup`. Method to use for replication. |
