...
| `cluster.certificates`                          | `{}`                          | The configuration for the CA and related certificates. See [CertificatesConfiguration](https://cloudnative-pg.io/documentation/current/cloudnative-pg.v1/#postgresql-cnpg-io-v1-CertificatesConfiguration).              |
...
| `cluster.postgresql`                            | `{}`                          | Configuration of the PostgreSQL server. See [PostgreSQL Configuration](https://cloudnative-pg.io/documentation/current/cloudnative-pg.v1/#postgresql-cnpg-io-v1-PostgresConfiguration).                                  |
...
| `backups.scheduledBackups[].backupOwnerReference` | `self`                        | Indicates which ownerReference should be put inside the created backup resources. See [ScheduledBackupSpec](https://cloudnative-pg.io/documentation/current/cloudnative-pg.v1/#postgresql-cnpg-io-v1-ScheduledBackup). |
